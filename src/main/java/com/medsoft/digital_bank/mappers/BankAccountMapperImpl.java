package com.medsoft.digital_bank.mappers;
...
public class BankAccountMapperImpl {
    ...
    {
        //methode de base pour mapper
        //customerDTO.setId(customer.getId());
        //customerDTO.setName(customer.getName());
        //customerDTO.setEmail(customer.getEmail());

        CustomerDTO customerDTO = new CustomerDTO();
        BeanUtils.copyProperties(customer, customerDTO); //autre façon de mapper
        return  customerDTO ;
    }
    ...
    public SavingBankAccountDTO fromSavinBankAccount (SavingAccount savingAccount)
    {
        SavingBankAccountDTO savingBankAccountDTO  =  new SavingBankAccountDTO();
        BeanUtils.copyProperties(savingAccount, savingBankAccountDTO);
        //pour recuperer la clé etrangere
